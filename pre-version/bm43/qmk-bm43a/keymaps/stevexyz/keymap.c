...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { // 12+11+11+9
  [0] = LAYOUT(
    ...
    KC_LCTL, TT(1), KC_LALT, KC_SPC, MT(MOD_LGUI,KC_SPC), TT(1), KC_LEFT, KC_DOWN, KC_RGHT ),
...
//    KC_LCTL, LT(2,KC_APP), KC_LALT, KC_SPC, MT(MOD_LGUI,KC_SPC), TG(2), KC_HOME, KC_PGDN, KC_END ),
    KC_LCTL, LT(2,KC_APP), KC_LALT, KC_SPC, MT(MOD_LGUI,KC_SPC), LT(2,KC_INS), KC_HOME, KC_PGDN, KC_END ),
  [2] = LAYOUT(
    TO(0), KC_PSCR, KC_SCRL, KC_PAUS, KC_PSLS, KC_PAST, KC_7, KC_8, KC_9, KC_PMNS, KC_PEQL, KC_BSPC,
    KC_CAPS, KC_MPLY, KC_STOP, KC_MPRV, KC_MNXT, XXXXXXX, KC_4, KC_5, KC_6, KC_PPLS, KC_PENT,
    TO(2), KC_MUTE, KC_VOLD, KC_VOLU, KC_COMM, KC_1, KC_2, KC_3, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2,
    TO(3), XXXXXXX, XXXXXXX, KC_SPC, KC_0, KC_DOT, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT ),
  [3] = LAYOUT(
    TO(0), KC_SLEP, KC_BRID, KC_BRIU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,
